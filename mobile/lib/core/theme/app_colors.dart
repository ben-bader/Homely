...
class AppColors {
  ...
  // ==================== SEMANTIC COLORS ====================
  static const Color success = Color(0xFF2E8B6A); // Teal-green
  static const Color successLight = Color(0xFF3DAF87);

  static const Color error = Color(0xFFCF4A3C); // Muted red
