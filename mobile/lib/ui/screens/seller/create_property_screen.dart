...
import '../../../ui/providers/seller_providers.dart';
...
class _CreatePropertyScreenState extends ConsumerState<CreatePropertyScreen>
  ...
  Map<String, dynamic> _buildPropertyTypeData() {
    switch (_propertyType) {
      ...
      case 'STUDIO':
        return {
          'studio': {'furnished': furnished},
        };
      case 'COMMERCIAL':
        return {
          'commercial': {'businessType': businessType, 'areaSqm': area},
        };
      case 'LAND':
        return {
          'land': {'areaSqm': area, 'constructible': constructible},
        };
      default:
        return {};
    }
