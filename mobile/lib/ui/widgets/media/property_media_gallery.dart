...
class PropertyMediaGallery extends ConsumerWidget {
  ...
  final bool editable;
  final void Function(PropertyMediaEntity video)? onVideoTap;
  ...
  static void _openVideoPlayer(BuildContext context, PropertyMediaEntity video) {
    Navigator.push(
      context,
      MaterialPageRoute(
...
class _ImageGrid extends StatelessWidget {
  final List<PropertyMediaEntity> images;
  final bool editable;
  ...
  void _openFullscreen(
    ...
    List<PropertyMediaEntity> images,
    int initial,
  ) {
    Navigator.push(
      context,
...
class _VideoList extends StatelessWidget {
  final List<PropertyMediaEntity> videos;
  final bool editable;
  final Future<void> Function(String id)? onDelete;
  final void Function(PropertyMediaEntity video)? onVideoTap;
...
class _VideoTile extends StatelessWidget {
  ...
  final bool editable;
  final Future<void> Function(String id)? onDelete;
  final void Function(PropertyMediaEntity video)? onTap;
