...
import 'package:homely/domain/entities/boost/boost_package_entity.dart';
import '../../../ui/providers/boost_providers.dart';
...
class _BoostSheetState extends ConsumerState<BoostSheet> {
  ...
  String _badgeFor(List<BoostPackageEntity> packages, int index) {
  ...
  Future<void> _purchase(BoostPackageEntity plan) async {
        ...
        children: [
          ...
          packagesAsync.when(
            ...
            error: (e, _) => Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  TextButton.icon(
                    onPressed: () => ref.invalidate(boostPackagesProvider),
            ...
            data: (packages) {
              ...
              final safeIndex = _selectedPlanIndex.clamp(
                0,
                packages.length - 1,
              );
