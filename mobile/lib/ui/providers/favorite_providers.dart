...
final isPropertyFavoritedProvider = FutureProvider.family<bool, String>((
  ref,
  propertyId,
) async {
...
class FavoritesNotifier extends AsyncNotifier<List<FavoriteEntity>> {
  @override
  Future<List<FavoriteEntity>> build() async => _fetchFavorites();
  ...
  Future<void> addFavorite(String propertyId, {String? mediaId}) async {
    ...
    await ref.read(favoriteRepositoryProvider).addFavorite(favorite);
