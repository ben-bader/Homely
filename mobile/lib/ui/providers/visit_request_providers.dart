...
final visitRequestRepositoryProvider =
    Provider<IVisitRequestRepository>((ref) {
...
class MyVisitRequestsNotifier
    extends AsyncNotifier<List<VisitRequestEntity>> {
  @override
...
final sellerVisitRequestsProvider = AsyncNotifierProviderFamily<
    SellerVisitRequestsNotifier,
    List<VisitRequestEntity>,
    String>(SellerVisitRequestsNotifier.new);
...
class SellerVisitRequestsNotifier
  ...
  Future<void> updateStatus({
    ...
    final previous = state;
    state.whenData((list) => state = AsyncData(list
